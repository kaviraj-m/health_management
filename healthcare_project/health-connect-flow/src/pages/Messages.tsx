...
import { Bell, Send, Paperclip, Search, Phone, Video, Loader2, Building2 } from "lucide-react";
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="bg-white border-b border-gray-200 p-4 flex justify-between items-center">
          <div>
            ...
            <p className="text-sm text-gray-500">Chat with healthcare providers</p>
          </div>
                  ...
                  >
                    <div className="flex items-start">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-gray-500 capitalize">{conversation.otherUser.role}</p>
                        {conversation.lastMessage && (
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500 capitalize">
                        {conversations.find(c => c.otherUser.id === activeConversation)?.otherUser.role}
                      </p>
                    </div>
                  </div>
